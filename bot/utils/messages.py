...
def get_help_message(language: str = "en") -> str:
    ...
    messages = {
        "en": (
            ...
            "<b>Pricing:</b>\n"
            f"• Audio: {settings.AUDIO_PRICE_PER_MIN} UZS per minute\n"
            f"• Video: {settings.VIDEO_PRICE_PER_MIN} UZS per minute\n\n"
            "<b>Limits:</b>\n"
            f"• Max audio duration: {settings.MAX_AUDIO_DURATION_SECONDS // 60} minutes\n"
            f"• Max video duration: {settings.MAX_VIDEO_DURATION_SECONDS // 60} minutes\n"
        ...
        "ru": (
            ...
            "<b>Цены:</b>\n"
            f"• Аудио: {settings.AUDIO_PRICE_PER_MIN} UZS за минуту\n"
            f"• Видео: {settings.VIDEO_PRICE_PER_MIN} UZS за минуту\n\n"
            "<b>Ограничения:</b>\n"
            f"• Макс. длительность аудио: {settings.MAX_AUDIO_DURATION_SECONDS // 60} минут\n"
            f"• Макс. длительность видео: {settings.MAX_VIDEO_DURATION_SECONDS // 60} минут\n"
        ...
        "uz": (
            ...
            "<b>Narxlar:</b>\n"
            f"• Audio: {settings.AUDIO_PRICE_PER_MIN} UZS daqiqasiga\n"
            f"• Video: {settings.VIDEO_PRICE_PER_MIN} UZS daqiqasiga\n\n"
            "<b>Cheklovlar:</b>\n"
            f"• Audio maksimal davomiyligi: {settings.MAX_AUDIO_DURATION_SECONDS // 60} daqiqa\n"
            f"• Video maksimal davomiyligi: {settings.MAX_VIDEO_DURATION_SECONDS // 60} daqiqa\n"
            f"• Fayl maksimal hajmi: {settings.MAX_FILE_SIZE_MB} MB\n\n"
            "<b>Buyruqlar:</b>\n"
