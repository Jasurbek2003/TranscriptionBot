...
class TelegramUserAdmin(BaseUserAdmin):
    ...
    list_filter = ["status", "role", "language_code", "is_premium", "is_bot", "created_at"]
    ...
    fieldsets = (
        ...
        (_("Activity"), {"fields": ("last_activity", "total_transcriptions", "total_spent")}),
        (_("Settings"), {"fields": ("notifications_enabled", "metadata")}),
        (
            _("Important dates"),
            {"fields": ("last_login", "date_joined", "created_at", "updated_at")},
        ),
        (_("Ballance"), {"fields": ("wallet_balance",)}),
    )
    ...
    def role_badge(self, obj):
        ...
        colors = {"user": "gray", "moderator": "blue", "admin": "orange", "super_admin": "red"}
    ...
    def status_badge(self, obj):
        ...
        colors = {"active": "green", "inactive": "gray", "blocked": "red", "deleted": "black"}
    ...
    def wallet_balance(self, obj):
        ...
        try:
            wallet = obj.wallet
            return format_html(
                '<span style="font-weight: bold;">{:,.2f} UZS</span>', wallet.balance
            )
        except (AttributeError, ValueError):
            # User has no wallet or invalid balance
            return "-"
