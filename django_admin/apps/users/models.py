...
from core.enums import UserRole, UserStatus, Language
...
class TelegramUser(AbstractUser):
    ...
    is_premium = models.BooleanField(
        default=False,
        verbose_name=_("Has Telegram Premium")
    )
    ...
    total_transcriptions = models.IntegerField(
        default=0,
        verbose_name=_("Total Transcriptions")
    )
