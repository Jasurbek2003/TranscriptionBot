...
class WalletAdmin(admin.ModelAdmin):
    ...
    activate_wallets.short_description = _('Activate selected wallets')
    ...
    deactivate_wallets.short_description = _('Deactivate selected wallets')
    ...
    def add_bonus(self, request, queryset):
        ...
        self.message_user(
            request,
            f'Added {bonus_amount} {wallet.currency} bonus to {queryset.count()} wallets.'
        )

    add_bonus.short_description = _('Add 100 UZS bonus')