...
# Don't create static_root here as it's created by collectstatic
...
# Database configuration - switches between SQLite and PostgreSQL
...
if USE_SQLITE:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "transcription_bot"),
...
STATICFILES_DIRS = []  # Add BASE_DIR / 'static' if you create a static folder
...
# Logging Configuration - SAFE VERSION
LOGGING = {
    "version": 1,
